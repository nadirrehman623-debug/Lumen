...
def dashboard():
    ...
    system_prompt = (
        ...
        f"Always return a JSON array (a list) and not a dictionary object, and within that file, subjects, connection and summary as keys to the name of subjects that are connected, "
